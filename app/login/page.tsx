...
export default function LoginPage(){
  ...
  const [returnTo,setReturnTo]=useState('/profile');const [bookmarkNotice,setBookmarkNotice]=useState(false);
  useEffect(()=>{const params=new URLSearchParams(location.search);const next=params.get('next');if(next?.startsWith('/'))setReturnTo(next);setBookmarkNotice(params.get('reason')==='bookmark')},[]);
