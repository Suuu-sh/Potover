...
export default function Article({params}:{params:{slug:string}}){
  ...
  return <main className="shell page shared-header-page article-detail-page"><article className="detail">
    ...
    <div className="detailbox">
      ...
      <div className="detail-footer"><div className="detail-tags">{a.tags.map(t=><span className="tag" key={t}>{t}</span>)}</div><LearningLink className="cta" slug={a.slug} href={a.url}>元記事を読む ↗</LearningLink></div>
    </div>
  </article></main>
}
