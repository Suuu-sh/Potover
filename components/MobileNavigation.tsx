...
import {Bookmark,Compass,Home,Map,Menu,UserCircle,UserRoundPlus,X} from 'lucide-react';
...
export function MobileNavigation({accountHref,accountLabel,showRoadmap,roadmapHref='/roadmap'}:Props){
  ...
  const links=[{href:'/',label:'ホーム',Icon:Home},{href:'/docs',label:'探す',Icon:Compass},...(showRoadmap?[{href:roadmapHref,label:'ロードマップ',Icon:Map}]:[]),{href:'/bookmarks',label:'ブックマーク',Icon:Bookmark},{href:accountHref,label:accountLabel,Icon:accountLabel==='アカウント'?UserCircle:UserRoundPlus}];
