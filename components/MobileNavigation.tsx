...
export function MobileNavigation({accountHref,accountLabel,showRoadmap,roadmapHref='/roadmap'}:Props){
  ...
  const links=[{href:'/',label:'ホーム',Icon:Home},{href:'/explore',label:'探す',Icon:Compass},{href:'/glossary',label:'用語集',Icon:BookOpenText},...(showRoadmap?[{href:roadmapHref,label:'ロードマップ',Icon:Map}]:[]),{href:'/bookmarks',label:'ブックマーク',Icon:Bookmark},{href:accountHref,label:accountLabel,Icon:accountLabel==='アカウント'?UserCircle:UserRoundPlus}];
