...
export function AccountSecurity(){
  ...
  return <div className="account-security-grid">
    <section className="account-security-card" aria-labelledby="password-heading">
      <div className="account-security-heading"><span className="account-setting-icon"><KeyRound size={21}/></span><div><p className="account-card-eyebrow">SECURITY</p><h2 id="password-heading">パスワードを変更</h2><p>定期的に変更すると、より安心して利用できます。</p></div></div>
    ...
    <section className="account-security-card account-danger-card" aria-labelledby="delete-account-heading">
      <div className="account-security-heading"><span className="account-danger-icon"><ShieldAlert size={21}/></span><div><p className="account-card-eyebrow">DANGER ZONE</p><h2 id="delete-account-heading">アカウントを削除</h2><p>保存したデータも削除され、元に戻せません。</p></div></div>
